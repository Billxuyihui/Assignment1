...
* PointCP3Test2 &lt;coordtype (c/p)&gt; &lt;X/RHO&gt; &lt;Y/THETA&gt;
...
public static void main(String[] args)
{
 ...
 System.out.println("\nAfter asking to print as Polar:\n" + point);
}
...
private static PointCP3 getInput() throws IOException
{
 ...
 for (int i = 0; i < 3; i++)
 {
   while (!(isOK))
   {
     ...
     {
       System.out.print("you can only input cartesian coordinates here. Please type C to comfirm : ");
     }
